...
$query   = $conn->query("select about from tbl_configuration where id=1"); 
...
if(isset($_POST['btnUpdate']))
{
	$txtDesc= mysqli_real_escape_string($conn,$_POST['txtDesc']);
  	...
  	$sql = "UPDATE tbl_configuration set about='$txtDesc', modify_by=$userId where id=1";
...
<html lang="en">
	...
	<head><base href="">
		<meta charset="utf-8" />
		<title>About | <?php echo $appDetRes['app_name'] ?></title>
												...
												<div class="card-body">
													...
													<div class="col-lg-12">
														<div class="form-group">
															<textarea name="txtDesc" class="form-control" required><?php echo $result['about']; ?></textarea>
															<script>
