...
if(isset($_POST['btnUpdate']))
{
	...
	$txtVname= mysqli_real_escape_string($conn,$_POST['txtVname']);
	$txtVcode= mysqli_real_escape_string($conn,$_POST['txtVcode']);
	$txtUpUrl= mysqli_real_escape_string($conn,$_POST['txtUpUrl']);
	$txtUpDate = date('Y-m-d');

  	$sql = "UPDATE tbl_app_details SET force_update='$txtFupdate', whats_new='$txtDesc', update_date='$txtUpDate', latest_version_name='$txtVname', update_url='$txtUpUrl', latest_version_code='$txtVcode' where id=1";
