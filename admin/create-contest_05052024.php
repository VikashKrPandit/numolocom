													...
													<div class="row">
															<div class="col-md-3">
																<div class="form-group">
																	...
																	<select name="pkg_id" id="" class="form-select" required>
																		<option select disabled>Select PKG</option>
																		<?php 
																		if(mysqli_num_rows($getPkg)>0){
																			while($pkgf=$getPkg->fetch_assoc()){ ?>
															...
															<div class="col-md-3">
																<div class="form-group">
																	...
																	<select name="fee_id" id="" class="form-select" required>
																		<option select disabled>Select PKG</option>
																		<?php 
																		if(mysqli_num_rows($getFeemaster)>0){
																			while($feef=$getFeemaster->fetch_assoc()){ ?>
												...
												<table id="example" class="datatable-table table-hover table table-separate dataTable dtr-inline" style="width:100%">
													...
													<tbody>
											        	...
											        	<tr>
											        		...
											        		<td>
											        			<!-- <a href="#" data-toggle="modal" data-target="#addDummyParti" class="btn btn-sm btn-clean btn-icon mr-2" title="Add Dummy Participants">
