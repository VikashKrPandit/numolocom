...
$query   = $conn->query("select terms from tbl_configuration where id=1"); 
...
if(isset($_POST['btnUpdate']))
{
	$txtDesc= mysqli_real_escape_string($conn,$_POST['txtDesc']);
  	...
  	$sql = "UPDATE tbl_configuration set terms='$txtDesc', modify_by=$userId where id=1";
...
<html lang="en">
	...
	<head><base href="">
		<meta charset="utf-8" />
		<title>Terms & Conditions | <?php echo $appDetRes['app_name'] ?></title>
						...
						<div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
							<div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
								...
								<div class="d-flex align-items-center flex-wrap mr-2">
									<!--begin::Page Title-->
									<h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5">Terms & Conditions</h5>
									<!--end::Page Title-->
								</div>
								<!--end::Info-->
								<!--begin::Toolbar-->
												...
												<div class="card-body">
													...
													<div class="col-lg-12">
														<div class="form-group">
															<textarea name="txtDesc" class="form-control" required><?php echo $result['terms']; ?></textarea>
															<script>
